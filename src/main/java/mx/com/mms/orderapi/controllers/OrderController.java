...
public class OrderController {
	...
	public ResponseEntity<Object> getAll(
			...
			@And({ 
				@Spec(path = "totalGreaterThanOrEqual", params = "GreaterThanOrEqual", spec = GreaterThanOrEqual.class) 
	...
	public ResponseEntity<Object> create(@Valid @RequestBody OrderDTO order) {
		...
		URI uri = MvcUriComponentsBuilder.fromController(getClass()).path("/{id}").buildAndExpand(orderSave.getId()).toUri();
